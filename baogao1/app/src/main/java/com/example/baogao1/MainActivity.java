...
public class MainActivity extends AppCompatActivity {
    ...
    Button btn_newWaypoint,btn_showMyPointList,btn_showMap;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_showMyPointList = findViewById(R.id.btn_showWayPointList);
        tv_wayPointCounts=findViewById(R.id.tv_countOfCrumbs);
        btn_showMap = findViewById(R.id.btn_showMap);

        //set all properties of LocationRequest
        locationRequest = new LocationRequest();
        //how often does thee default location check occur?
        ...
        btn_newWaypoint.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                savedLocations = Baogao12.getMyLocations();
                savedLocations.add(currentLocation);
            }
        });

        btn_showMyPointList.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(MainActivity.this,baogao2.class);
                startActivity(i);
            }
        });
    ...
    /*private void updateGPS() {
        ...
        if (ActivityCompat.checkSelfPermission(MainActivity.this, Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED
            ...
            tv_updates.setText("This app requires permission to be granted in order to work");
